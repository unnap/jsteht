...
const imgB = document.querySelector('dialog img');
const close = document.querySelector('dialog span');
...
for(let pic of picArray){
  ...
  figcaption.innerText = pic.caption;
